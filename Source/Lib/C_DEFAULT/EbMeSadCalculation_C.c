...
the best SAD+MV
*******************************************/
void eb_vp9_sad_calculation_8x8_16x16(uint8_t *src, uint32_t src_stride, uint8_t *ref, uint32_t ref_stride,
    ...
    sad8x8_2 = (compute8x4_sad_kernel(src + (src_stride << 3), src_stride_sub, ref + (ref_stride << 3), ref_stride_sub))
        << 1;
    ...
    sad8x8_3 = (compute8x4_sad_kernel(
                   src + (src_stride << 3) + 8, src_stride_sub, ref + (ref_stride << 3) + 8, ref_stride_sub))
        << 1;
...
the best SAD+MV
*******************************************/
void eb_vp9_sad_calculation_32x32_64x64(uint32_t *p_sad16x16, uint32_t *p_best_sad32x32, uint32_t *p_best_sad64x64,
...
void eb_vp9_initialize_buffer_32bits(uint32_t *pointer, uint32_t count128, uint32_t count32, uint32_t value) {
