...
static void lpf_horizontal_16_sse2(unsigned char *s, int p, const unsigned char *_blimit, const unsigned char *_limit,
...
void eb_vp9_lpf_vertical_16_sse2(unsigned char *s, int p, const unsigned char *blimit, const unsigned char *limit,
    ...
    // Loop filtering
    lpf_horizontal_16_sse2(t_dst + 8 * 8, 8, blimit, limit, thresh);
