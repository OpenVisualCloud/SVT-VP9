...
void eb_vp9_lpf_horizontal_4_sse2(uint8_t *s, int p /* pitch */,
...
void eb_vp9_lpf_vertical_4_sse2(uint8_t *s, int p /* pitch */,
                             const uint8_t *_blimit, const uint8_t *_limit,
                             const uint8_t *_thresh) {
  const __m128i zero = _mm_set1_epi16(0);
  const __m128i limit =
...
void eb_vp9_lpf_horizontal_16_sse2(unsigned char *s, int p,
...
void eb_vp9_lpf_horizontal_16_dual_sse2(unsigned char *s, int p,
                                     const unsigned char *_blimit,
                                     const unsigned char *_limit,
                                     const unsigned char *_thresh) {
  const __m128i zero = _mm_set1_epi16(0);
...
void eb_vp9_lpf_horizontal_8_sse2(unsigned char *s, int p,
                               const unsigned char *_blimit,
                               const unsigned char *_limit,
                               const unsigned char *_thresh) {
...
void eb_vp9_lpf_horizontal_8_dual_sse2(uint8_t *s, int p, const uint8_t *_blimit0,
...
void eb_vp9_lpf_horizontal_4_dual_sse2(unsigned char *s, int p,
...
void eb_vp9_lpf_vertical_4_dual_sse2(uint8_t *s, int p, const uint8_t *blimit0,
  ...
  // Loop filtering
  eb_vp9_lpf_horizontal_4_dual_sse2(t_dst + 4 * 16, 16, blimit0, limit0, thresh0,
...
void eb_vp9_lpf_vertical_8_sse2(unsigned char *s, int p,
...
void eb_vp9_lpf_vertical_8_dual_sse2(uint8_t *s, int p, const uint8_t *blimit0,
                                  const uint8_t *limit0, const uint8_t *thresh0,
                                  const uint8_t *blimit1, const uint8_t *limit1,
                                  const uint8_t *thresh1) {
  DECLARE_ALIGNED(16, unsigned char, t_dst[16 * 8]);
  ...
  // Loop filtering
  eb_vp9_lpf_horizontal_8_dual_sse2(t_dst + 4 * 16, 16, blimit0, limit0, thresh0,
                                 blimit1, limit1, thresh1);
  src[0] = t_dst;
  src[1] = t_dst + 8;
...
void eb_vp9_lpf_vertical_16_sse2(unsigned char *s, int p,
                              const unsigned char *blimit,
                              const unsigned char *limit,
                              const unsigned char *thresh) {
