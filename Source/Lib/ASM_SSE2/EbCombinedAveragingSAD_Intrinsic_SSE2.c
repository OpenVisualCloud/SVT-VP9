    ...
    uint32_t  width)
{
    ...
    for (y = 0; y < height; y += 2) {
        ...
        sad1 = _mm_add_epi32(sad1, _mm_sad_epu8(_mm_loadl_epi64((__m128i*)(src + src_stride)), _mm_avg_epu8(_mm_loadl_epi64((__m128i*)(ref1 + ref1_stride)), _mm_loadl_epi64((__m128i*)(ref2 + ref2_stride)))));
        src += src_stride << 1;
        ref1 += ref1_stride << 1;
        ref2 += ref2_stride << 1;
