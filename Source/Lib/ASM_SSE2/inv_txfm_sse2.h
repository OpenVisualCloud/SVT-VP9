...
static INLINE void idct16_8col(const __m128i *const in /*in[16]*/, __m128i *const out /*out[16]*/) {
    ...
    butterfly(step1[14], step1[9], cospi_24_64, cospi_8_64, &step2[9], &step2[14]);
    butterfly(step1[10], step1[13], -cospi_8_64, -cospi_24_64, &step2[13], &step2[10]);
    step2[5]  = _mm_sub_epi16(step1[4], step1[5]);
    ...
    step2[8] = step1[8];
    step2[9] = step1[9];
    butterfly(step1[13], step1[10], cospi_16_64, cospi_16_64, &step2[10], &step2[13]);
    butterfly(step1[12], step1[11], cospi_16_64, cospi_16_64, &step2[11], &step2[12]);
    step2[14] = step1[14];
    step2[15] = step1[15];
...
static INLINE void idct16x16_10_pass2(__m128i *const l /*l[8]*/, __m128i *const io /*io[16]*/) {
    ...
    butterfly(step2[15], step2[8], cospi_24_64, cospi_8_64, &step2[9], &step2[14]);
    butterfly(step2[11], step2[12], -cospi_8_64, -cospi_24_64, &step2[13], &step2[10]);
...
static INLINE void idct32_8x32_quarter_2_stage_4_to_6(__m128i *const step1 /*step1[16]*/,
    ...
    step2[15] = step1[15];
    butterfly(step1[14], step1[9], cospi_24_64, cospi_8_64, &step2[9], &step2[14]);
    butterfly(step1[13], step1[10], -cospi_8_64, cospi_24_64, &step2[10], &step2[13]);
    step2[11] = step1[11];
    step2[12] = step1[12];
...
static INLINE void idct32_8x32_quarter_3_4_stage_4_to_7(__m128i *const step1 /*step1[32]*/,
    ...
    step1[16] = step2[16];
    step1[17] = step2[17];
    butterfly(step2[29], step2[18], cospi_24_64, cospi_8_64, &step1[18], &step1[29]);
    butterfly(step2[28], step2[19], cospi_24_64, cospi_8_64, &step1[19], &step1[28]);
    butterfly(step2[27], step2[20], -cospi_8_64, cospi_24_64, &step1[20], &step1[27]);
    butterfly(step2[26], step2[21], -cospi_8_64, cospi_24_64, &step1[21], &step1[26]);
    step1[22] = step2[22];
    step1[23] = step2[23];
    step1[24] = step2[24];
    step1[25] = step2[25];
