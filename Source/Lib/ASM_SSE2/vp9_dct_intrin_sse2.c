...
void eb_vp9_fdct4x4_sse2(const int16_t *input, tran_low_t *output, int stride) {
    ...
    cmp0 = _mm_xor_si128(_mm_cmpgt_epi16(in0, _mm_set1_epi16(0x3ff)), _mm_cmplt_epi16(in0, _mm_set1_epi16(0xfc00)));
    cmp1 = _mm_xor_si128(_mm_cmpgt_epi16(in1, _mm_set1_epi16(0x3ff)), _mm_cmplt_epi16(in1, _mm_set1_epi16(0xfc00)));
...
// load 8x8 array
static INLINE void load_buffer_left_shift2_8x8(const int16_t *const input, const int stride, __m128i *const in) {
...
static INLINE void highbd_add_sub_8x4_sse2(const __m128i *const in, __m128i *const out) {
...
static INLINE void highbd_add_sub_8x8_sse2(const __m128i *const in, __m128i *const out) {
...
// write 8x8 array
static INLINE void write_buffer_8x8(const __m128i *const res, tran_low_t *const output, const int stride) {
...
#endif
static INLINE void fadst8_core_sse2(const __m128i *const in, const __m128i c0, const __m128i c1, __m128i *const out0,
                                    __m128i *const out1) {
    const __m128i k__DCT_CONST_ROUNDING = _mm_set1_epi32(DCT_CONST_ROUNDING);
    __m128i       u[4], v[4];
...
static INLINE void fadst8_kernel_sse2(const __m128i in0, const __m128i in1, const __m128i in2, const __m128i in3,
...
static INLINE void load_buffer_left_shift2_16x16(const int16_t *input, const int stride, __m128i *const in0,
                                                 __m128i *const in1) {
...
static INLINE void write_buffer_16x16(const __m128i *const res0, const __m128i *const res1, tran_low_t *output,
                                      const int stride) {
...
static INLINE void right_shift_fdct_16x16(__m128i *const res0, __m128i *const res1) {
