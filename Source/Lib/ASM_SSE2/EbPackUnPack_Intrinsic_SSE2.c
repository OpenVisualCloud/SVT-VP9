...
void eb_enc_un_pack8_bit_data_safe_sub_sse2_intrin(uint16_t *in16_bit_buffer, uint32_t in_stride,
                                                   uint8_t *out8_bit_buffer, uint32_t out8_stride, uint32_t width,
                                                   uint32_t height) {
    uint32_t x, y;

    __m128i xmm_00FF, in_pixel0, in_pixel1, inPixel1_shftR_2_U8, inPixel0_shftR_2_U8, inPixel0_shftR_2,
        inPixel1_shftR_2;
...
void eb_enc_un_pack8_bit_data_sse2_intrin(uint16_t *in16_bit_buffer, uint32_t in_stride, uint8_t *out8_bit_buffer,
...
void eb_vp9_unpack_avg_sse2_intrin(uint16_t *ref16_l0, uint32_t ref_l0_stride, uint16_t *ref16_l1,
