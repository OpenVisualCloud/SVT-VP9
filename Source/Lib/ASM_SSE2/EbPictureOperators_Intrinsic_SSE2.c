...
*******************************************************************************/
void eb_vp9_picture_addition_kernel4x4_sse_intrin(uint8_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
    ...
    for (y = 0; y < 4; ++y) {
        recon_0_3 = _mm_packus_epi16(_mm_add_epi16(_mm_unpacklo_epi8(_mm_cvtsi32_si128(*(uint32_t *)pred_ptr), xmm0),
...
void eb_vp9_picture_addition_kernel8x8_sse2_intrin(uint8_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
                                                   uint32_t residual_stride, uint8_t *recon_ptr, uint32_t recon_stride,
                                                   uint32_t width, uint32_t height) {
    ...
    for (y = 0; y < 8; ++y) {
        recon_0_7 = _mm_packus_epi16(_mm_add_epi16(_mm_unpacklo_epi8(_mm_loadl_epi64((__m128i *)pred_ptr), xmm0),
...
void eb_vp9_picture_addition_kernel16x16_sse2_intrin(uint8_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
...
void eb_vp9_picture_addition_kernel32x32_sse2_intrin(uint8_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
                                                     uint32_t residual_stride, uint8_t *recon_ptr,
                                                     uint32_t recon_stride, uint32_t width, uint32_t height) {
    uint32_t y;
    __m128i  xmm0, pred_0_15, pred_16_31, recon_0_15_clipped, recon_0_7, recon_8_15, recon_16_23, recon_24_31,
        recon_16_31_clipped;
    xmm0 = _mm_setzero_si128();
    ...
    for (y = 0; y < 32; ++y) {
        ...
        recon_0_7   = _mm_add_epi16(_mm_unpacklo_epi8(pred_0_15, xmm0), _mm_loadu_si128((__m128i *)residual_ptr));
        recon_8_15  = _mm_add_epi16(_mm_unpackhi_epi8(pred_0_15, xmm0), _mm_loadu_si128((__m128i *)(residual_ptr + 8)));
        recon_16_23 = _mm_add_epi16(_mm_unpacklo_epi8(pred_16_31, xmm0),
                                    _mm_loadu_si128((__m128i *)(residual_ptr + 16)));
        recon_24_31 = _mm_add_epi16(_mm_unpackhi_epi8(pred_16_31, xmm0),
...
void eb_vp9_picture_addition_kernel64x64_sse2_intrin(uint8_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
                                                     uint32_t residual_stride, uint8_t *recon_ptr,
                                                     uint32_t recon_stride, uint32_t width, uint32_t height) {
    uint32_t y;
    ...
    for (y = 0; y < 64; ++y) {
        ...
        recon_24_31 = _mm_add_epi16(_mm_unpackhi_epi8(pred_16_31, xmm0),
                                    _mm_loadu_si128((__m128i *)(residual_ptr + 24)));
        recon_32_39 = _mm_add_epi16(_mm_unpacklo_epi8(pred_32_47, xmm0),
                                    _mm_loadu_si128((__m128i *)(residual_ptr + 32)));
        recon_40_47 = _mm_add_epi16(_mm_unpackhi_epi8(pred_32_47, xmm0),
                                    _mm_loadu_si128((__m128i *)(residual_ptr + 40)));
        recon_48_55 = _mm_add_epi16(_mm_unpacklo_epi8(pred_48_63, xmm0),
                                    _mm_loadu_si128((__m128i *)(residual_ptr + 48)));
        recon_56_63 = _mm_add_epi16(_mm_unpackhi_epi8(pred_48_63, xmm0),
...
***********************************************************************************************************/
void eb_vp9_residual_kernel_sub_sampled4x4_sse_intrin(uint8_t *input, uint32_t input_stride, uint8_t *pred,
...
void eb_vp9_residual_kernel_sub_sampled8x8_sse2_intrin(uint8_t *input, uint32_t input_stride, uint8_t *pred,
    ...
    for (y = 0; y < area_height; ++y) {
        residual_0_7 = _mm_sub_epi16(_mm_unpacklo_epi8(_mm_loadl_epi64((__m128i *)input), xmm0),
                                     _mm_unpacklo_epi8(_mm_loadl_epi64((__m128i *)pred), xmm0));
...
void eb_vp9_residual_kernel_sub_sampled16x16_sse2_intrin(uint8_t *input, uint32_t input_stride, uint8_t *pred,
                                                         uint32_t pred_stride, int16_t *residual,
                                                         uint32_t residual_stride, uint32_t area_width,
                                                         uint32_t area_height, uint8_t last_line
    ...
    for (y = 0; y < area_height; ++y) {
        residual_0_7  = _mm_sub_epi16(_mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)input), xmm0),
                                     _mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)pred), xmm0));
        residual_8_15 = _mm_sub_epi16(_mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)input), xmm0),
                                      _mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)pred), xmm0));
...
void eb_vp9_residual_kernel_sub_sampled32x32_sse2_intrin(uint8_t *input, uint32_t input_stride, uint8_t *pred,
                                                         uint32_t pred_stride, int16_t *residual,
                                                         uint32_t residual_stride, uint32_t area_width,
                                                         uint32_t area_height, uint8_t last_line) {
    ...
    for (y = 0; y < area_height; ++y) {
        ...
        residual_8_15  = _mm_sub_epi16(_mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)input), xmm0),
                                      _mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)pred), xmm0));
        residual_16_23 = _mm_sub_epi16(_mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)(input + 16)), xmm0),
                                       _mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)(pred + 16)), xmm0));
        residual_24_31 = _mm_sub_epi16(_mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(input + 16)), xmm0),
                                       _mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(pred + 16)), xmm0));
...
void eb_vp9_residual_kernel_sub_sampled64x64_sse2_intrin(uint8_t *input, uint32_t input_stride, uint8_t *pred,
                                                         uint32_t pred_stride, int16_t *residual,
                                                         uint32_t residual_stride, uint32_t area_width,
                                                         uint32_t area_height, uint8_t last_line) {
    __m128i xmm0, residual_0_7, residual_8_15, residual_16_23, residual_24_31, resdiaul_32_39, residual_40_47,
        residual_48_55, residual_56_63;
    uint32_t y;
    ...
    for (y = 0; y < area_height; ++y) {
        ...
        residual_24_31 = _mm_sub_epi16(_mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(input + 16)), xmm0),
                                       _mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(pred + 16)), xmm0));
        resdiaul_32_39 = _mm_sub_epi16(_mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)(input + 32)), xmm0),
                                       _mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)(pred + 32)), xmm0));
        residual_40_47 = _mm_sub_epi16(_mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(input + 32)), xmm0),
                                       _mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(pred + 32)), xmm0));
        residual_48_55 = _mm_sub_epi16(_mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)(input + 48)), xmm0),
                                       _mm_unpacklo_epi8(_mm_loadu_si128((__m128i *)(pred + 48)), xmm0));
        residual_56_63 = _mm_sub_epi16(_mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(input + 48)), xmm0),
                                       _mm_unpackhi_epi8(_mm_loadu_si128((__m128i *)(pred + 48)), xmm0));
...
******************************************************************************************************/
void eb_vp9_residual_kernel16bit_sse2_intrin(uint16_t *input, uint32_t input_stride, uint16_t *pred,
                                             uint32_t pred_stride, int16_t *residual, uint32_t residual_stride,
                                             uint32_t area_width, uint32_t area_height) {
    uint32_t x, y;
...
void eb_vp9_picture_addition_kernel16bit_sse2_intrin(uint16_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
    ...
    if (width == 4) {
        ...
        for (y = 0; y < height; y += 2) {
            xmm_sum_0_3   = _mm_adds_epi16(_mm_loadl_epi64((__m128i *)pred_ptr),
                                         _mm_loadl_epi64((__m128i *)residual_ptr));
            xmm_sum_s0_s3 = _mm_adds_epi16(_mm_loadl_epi64((__m128i *)(pred_ptr + pred_stride)),
        ...
        for (y = 0; y < height; y += 2) {
            xmm_sum_0_7   = _mm_adds_epi16(_mm_loadu_si128((__m128i *)pred_ptr),
                                         _mm_loadu_si128((__m128i *)residual_ptr));
            xmm_sum_s0_s7 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride)),
        ...
        for (y = 0; y < height; y += 2) {
            ...
            sum_s0_s7  = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride)),
                                       _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride)));
            sum_s8_s15 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 8)),
        ...
        __m128i clip3_0_7, clip3_8_15, clip3_16_23, clip3_24_31, clip3_s0_s7, clip3_s8_s15, clip3_s16_s23,
            clip3_s24_s31;
        ...
        for (y = 0; y < height; y += 2) {
            ...
            sum_s8_s15  = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 8)),
                                        _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride + 8)));
            sum_s16_s23 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 16)),
                                         _mm_loadu_si128((__m128i *)(residual_ptr + residual_stride + 16)));
            sum_s24_s31 = _mm_adds_epi16(_mm_loadu_si128((__m128i *)(pred_ptr + pred_stride + 24)),
