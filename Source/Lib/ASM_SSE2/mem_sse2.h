...
static INLINE void loadu_8bit_16x16(const uint8_t *const s,
    const ptrdiff_t stride, __m128i *const d) {
...
static INLINE void storeu_8bit_16x8(const __m128i *const s, uint8_t *const d,
    const ptrdiff_t stride) {
    storeu_8bit_16x4(s + 0, d + 0 * stride, stride);
    storeu_8bit_16x4(s + 4, d + 4 * stride, stride);
}

static INLINE void storeu_8bit_16x16(const __m128i *const s, uint8_t *const d,
    const ptrdiff_t stride) {
    storeu_8bit_16x8(s + 0, d + 0 * stride, stride);
    storeu_8bit_16x8(s + 8, d + 8 * stride, stride);
}

static INLINE void store_16bit_8x8(const __m128i *const s, uint16_t *const d,
    const ptrdiff_t stride) {
