...
static INLINE void load_8bit_16x8(const uint8_t *const s, const ptrdiff_t stride, __m128i *const d) {
...
static INLINE void loadu_8bit_16x4(const uint8_t *const s, const ptrdiff_t stride, __m128i *const d) {
...
static INLINE void loadu_8bit_16x8(const uint8_t *const s, const ptrdiff_t stride, __m128i *const d) {
    loadu_8bit_16x4(s + 0 * stride, stride, &d[0]);
    loadu_8bit_16x4(s + 4 * stride, stride, &d[4]);
}

static INLINE void loadu_8bit_16x16(const uint8_t *const s, const ptrdiff_t stride, __m128i *const d) {
    loadu_8bit_16x8(s + 0 * stride, stride, &d[0]);
    loadu_8bit_16x8(s + 8 * stride, stride, &d[8]);
}
...
static INLINE void store_8bit_4x4(const __m128i *const s, uint8_t *const d, const ptrdiff_t stride) {
...
static INLINE void store_8bit_4x4_sse2(const __m128i s, uint8_t *const d, const ptrdiff_t stride) {
    __m128i ss[4];
...
static INLINE void store_8bit_8x4_from_16x2(const __m128i *const s, uint8_t *const d, const ptrdiff_t stride) {
...
static INLINE void store_8bit_8x8(const __m128i *const s, uint8_t *const d, const ptrdiff_t stride) {
    _mm_storel_epi64((__m128i *)(d + 0 * stride), s[0]);
...
static INLINE void storeu_8bit_16x4(const __m128i *const s, uint8_t *const d, const ptrdiff_t stride) {
...
static INLINE void storeu_8bit_16x8(const __m128i *const s, uint8_t *const d, const ptrdiff_t stride) {
    storeu_8bit_16x4(s + 0, d + 0 * stride, stride);
    storeu_8bit_16x4(s + 4, d + 4 * stride, stride);
}

static INLINE void storeu_8bit_16x16(const __m128i *const s, uint8_t *const d, const ptrdiff_t stride) {
    storeu_8bit_16x8(s + 0, d + 0 * stride, stride);
    storeu_8bit_16x8(s + 8, d + 8 * stride, stride);
}

static INLINE void store_16bit_8x8(const __m128i *const s, uint16_t *const d, const ptrdiff_t stride) {
    _mm_store_si128((__m128i *)(d + 0 * stride), s[0]);
    _mm_store_si128((__m128i *)(d + 1 * stride), s[1]);
    _mm_store_si128((__m128i *)(d + 2 * stride), s[2]);
    _mm_store_si128((__m128i *)(d + 3 * stride), s[3]);
    _mm_store_si128((__m128i *)(d + 4 * stride), s[4]);
    _mm_store_si128((__m128i *)(d + 5 * stride), s[5]);
    _mm_store_si128((__m128i *)(d + 6 * stride), s[6]);
    _mm_store_si128((__m128i *)(d + 7 * stride), s[7]);
}
