...
static EB_ALIGN(16) const int8_t avc_style_luma_if_coeff8_avx2[] = {
    ...
    -1, 25, -1, 25, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1,
    9,  -1, 9,  -1, 9,  -1, 9,  -1, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18,
    -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2,
    18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, 18, -2, -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,
    -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  -1, 9,  25, -1, 25, -1, 25, -1, 25, -1,
    25, -1, 25, -1, 25, -1, 25, -1, 25, -1, 25, -1, 25, -1, 25, -1, 25, -1, 25, -1, 25, -1, 25, -1};

static INLINE void avc_style_luma_interpolation_filter32(const __m256i ref0, const __m256i ref1, const __m256i ref2,
                                                         const __m256i ref3, const __m256i if_offset,
                                                         const __m256i IFCoeff_1_0, const __m256i if_coeff_3_2,
                                                         const EbByte dst) {
...
void eb_vp9_avc_style_luma_interpolation_filter_horizontal_avx2_intrin(EbByte ref_pic, uint32_t src_stride, EbByte dst,
    ...
    if (pu_width & 8) { // first 8
        ...
        do {
            ...
            avc_style_luma_interpolation_filter8(ref0, ref1, ref2, ref3, if_offset, IFCoeff_1_0, if_coeff_3_2, dst_t);
            refPic_t += src_stride;
            dst_t += dst_stride;
        } while (--height_cnt);
    ...
    if (pu_width & 16) { // first 16
        ...
        do {
            ...
            avc_style_luma_interpolation_filter16(ref0, ref1, ref2, ref3, if_offset, IFCoeff_1_0, if_coeff_3_2, dst_t);
            refPic_t += src_stride;
            dst_t += dst_stride;
        } while (--height_cnt);
    ...
    if (pu_width) { // 32x
        ...
        const __m256i IFCoeff_1_0_avx2 = _mm256_loadu_si256(
            (__m256i *)(avc_style_luma_if_coeff8_avx2 + 64 * frac_pos - 64));
        const __m256i IFCoeff_3_2_avx2 = _mm256_loadu_si256(
            (__m256i *)(avc_style_luma_if_coeff8_avx2 + 64 * frac_pos - 32));
        ...
        do {
            ...
            do {
                ...
                avc_style_luma_interpolation_filter32(
                    ref0, ref1, ref2, ref3, IFOffset_avx2, IFCoeff_1_0_avx2, IFCoeff_3_2_avx2, dst + width_cnt);
                width_cnt += 32;
...
void eb_vp9_avc_style_luma_interpolation_filter_vertical_avx2_intrin(EbByte ref_pic, uint32_t src_stride, EbByte dst,
                                                                     uint32_t dst_stride, uint32_t pu_width,
                                                                     uint32_t pu_height, EbByte temp_buf,
                                                                     uint32_t frac_pos) {
    const __m128i if_offset    = _mm_set1_epi16(16);
    ...
    if (pu_width) { // 32x
        ...
        do {
            ...
            do {
                ...
                avc_style_luma_interpolation_filter32(
                    ref0, ref1, ref2, ref3, IFOffset_avx2, IFCoeff_1_0_avx2, IFCoeff_3_2_avx2, dst_t);
                ref0 = ref1;
                ref1 = ref2;
                ref2 = ref3;
                refPic_t += src_stride;
