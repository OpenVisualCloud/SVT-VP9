        ...
        for (column_start = 0; column_start < 32; column_start += 16) {
            ...
            if (pass == 0) {
                ...
                }
                {
                    ...
                    const __m256i k32_m20_p12 = pair256_set_epi32(-cospi_20_64, cospi_12_64);
                    const __m256i k32_m12_m20 = pair256_set_epi32(-cospi_12_64, -cospi_20_64);
                    const __m256i k32_p12_p20 = pair256_set_epi32(cospi_12_64, cospi_20_64);
                    const __m256i k32_p28_p04 = pair256_set_epi32(cospi_28_64, cospi_4_64);
...
void eb_vpx_partial_fdct32x32_avx2(const int16_t *input, int16_t *output_org, int stride) {
    ...
    for (pass = 0; pass < 2; ++pass) {
        // We process sixteen columns (transposed rows in second pass) at a time.
        const int column_end = pass ? 16 : 32;
        int       column_start;
        for (column_start = 0; column_start < column_end; column_start += 16) {
            __m256i step1[32];
            __m256i step2[32];
            __m256i step3[32];
            __m256i out[16];
