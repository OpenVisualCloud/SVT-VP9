...
static INLINE void idct16_avx2(const __m256i *const in, __m256i *const out) {
    ...
    step2[8] = step1[8];
    step2[9] = step1[9];
    butterfly_avx2(step1[13], step1[10], cospi_16_64, cospi_16_64, &step2[10], &step2[13]);
    butterfly_avx2(step1[12], step1[11], cospi_16_64, cospi_16_64, &step2[11], &step2[12]);
    step2[14] = step1[14];
    step2[15] = step1[15];
...
void iadst16_avx2(__m256i *const in) {
    ...
    // stage 1
    iadst16_kernel_avx2(
        in[15], in[0], in[7], in[8], cospi_1_64, cospi_31_64, cospi_17_64, cospi_15_64, &s[0], &s[1], &s[8], &s[9]);
    iadst16_kernel_avx2(
        in[13], in[2], in[5], in[10], cospi_5_64, cospi_27_64, cospi_21_64, cospi_11_64, &s[2], &s[3], &s[10], &s[11]);
    iadst16_kernel_avx2(
        in[11], in[4], in[3], in[12], cospi_9_64, cospi_23_64, cospi_25_64, cospi_7_64, &s[4], &s[5], &s[12], &s[13]);
    iadst16_kernel_avx2(
        in[9], in[6], in[1], in[14], cospi_13_64, cospi_19_64, cospi_29_64, cospi_3_64, &s[6], &s[7], &s[14], &s[15]);
    ...
    iadst16_kernel_avx2(
        s[8], s[9], s[12], s[13], cospi_4_64, cospi_28_64, -cospi_28_64, cospi_4_64, &x[8], &x[9], &x[12], &x[13]);
    iadst16_kernel_avx2(s[10],
                        s[11],
                        s[14],
                        s[15],
                        cospi_20_64,
    ...
    iadst16_kernel_avx2(
        x[4], x[5], x[6], x[7], cospi_8_64, cospi_24_64, -cospi_24_64, cospi_8_64, &s[4], &s[5], &s[6], &s[7]);
    s[8]  = _mm256_add_epi16(x[8], x[10]);
    s[9]  = _mm256_add_epi16(x[9], x[11]);
    s[10] = _mm256_sub_epi16(x[8], x[10]);
    s[11] = _mm256_sub_epi16(x[9], x[11]);
    iadst16_kernel_avx2(
        x[12], x[13], x[14], x[15], cospi_8_64, cospi_24_64, -cospi_24_64, cospi_8_64, &s[12], &s[13], &s[14], &s[15]);
...
void eb_vp9_iht16x16_256_add_avx2(const tran_low_t *input, uint8_t *dest, int stride, int tx_type) {
    __m256i in[16];
...
void eb_vpx_idct32x32_1_add_avx2(const tran_low_t *input, uint8_t *dest, int stride) {
    ...
    for (j = 0; j < 32; ++j) { recon_and_store_32_avx2(dc_value, dest + j * stride); }
}
...
static INLINE void idct32_8x32_quarter_2_stage_4_to_6_avx2(__m256i *const step1, __m256i *const out) {
    ...
    step2[15] = step1[15];
    butterfly_avx2(step1[14], step1[9], cospi_24_64, cospi_8_64, &step2[9], &step2[14]);
    butterfly_avx2(step1[13], step1[10], -cospi_8_64, cospi_24_64, &step2[10], &step2[13]);
    step2[11] = step1[11];
    step2[12] = step1[12];
...
static INLINE void idct32_8x32_quarter_3_4_stage_4_to_7_avx2(__m256i *const step1, __m256i *const out) {
    ...
    step1[16] = step2[16];
    step1[17] = step2[17];
    butterfly_avx2(step2[29], step2[18], cospi_24_64, cospi_8_64, &step1[18], &step1[29]);
    butterfly_avx2(step2[28], step2[19], cospi_24_64, cospi_8_64, &step1[19], &step1[28]);
    butterfly_avx2(step2[27], step2[20], -cospi_8_64, cospi_24_64, &step1[20], &step1[27]);
    butterfly_avx2(step2[26], step2[21], -cospi_8_64, cospi_24_64, &step1[21], &step1[26]);
    step1[22] = step2[22];
    step1[23] = step2[23];
    step1[24] = step2[24];
    step1[25] = step2[25];
...
static INLINE void idct32_34_16x32_quarter_2_avx2(const __m256i *const in, __m256i *const out) {
    ...
    // stage 2
    partial_butterfly_avx2(in[2], cospi_30_64, cospi_2_64, &step2[8], &step2[15]);
    partial_butterfly_avx2(in[6], -cospi_26_64, cospi_6_64, &step2[11], &step2[12]);
...
static INLINE void idct32_34_16x32_quarter_3_4_avx2(const __m256i *const in, __m256i *const out) {
    ...
    // stage 1
    partial_butterfly_avx2(in[1], cospi_31_64, cospi_1_64, &step1[16], &step1[31]);
    partial_butterfly_avx2(in[7], -cospi_25_64, cospi_7_64, &step1[19], &step1[28]);
    partial_butterfly_avx2(in[5], cospi_27_64, cospi_5_64, &step1[20], &step1[27]);
    partial_butterfly_avx2(in[3], -cospi_29_64, cospi_3_64, &step1[23], &step1[24]);

    // stage 3
    butterfly_avx2(step1[31], step1[16], cospi_28_64, cospi_4_64, &step1[17], &step1[30]);
    butterfly_avx2(step1[28], step1[19], -cospi_4_64, cospi_28_64, &step1[18], &step1[29]);
    butterfly_avx2(step1[27], step1[20], cospi_12_64, cospi_20_64, &step1[21], &step1[26]);
    butterfly_avx2(step1[24], step1[23], -cospi_20_64, cospi_12_64, &step1[22], &step1[25]);

    idct32_8x32_quarter_3_4_stage_4_to_7_avx2(step1, out);
}

static void idct32_34_16x32_avx2(const __m256i *const in, __m256i *const out) {
    __m256i temp[32];
...
void eb_vp9_idct32x32_34_add_avx2(const tran_low_t *input, uint8_t *dest, int stride) {
    ...
    for (i = 0; i < 32; i += 16) {
        ...
        for (j = 0; j < 32; ++j) { write_buffer_16x1_avx2(io[j], dest + j * stride); }
...
static INLINE void idct32_135_16x32_quarter_1_avx2(const __m256i *const in, __m256i *const out) {
    ...
    // stage 3
    partial_butterfly_avx2(in[4], cospi_28_64, cospi_4_64, &step1[4], &step1[7]);
    partial_butterfly_avx2(in[12], -cospi_20_64, cospi_12_64, &step1[5], &step1[6]);
...
static INLINE void idct32_135_16x32_quarter_2_avx2(const __m256i *const in, __m256i *const out) {
    ...
    // stage 2
    partial_butterfly_avx2(in[2], cospi_30_64, cospi_2_64, &step2[8], &step2[15]);
    partial_butterfly_avx2(in[14], -cospi_18_64, cospi_14_64, &step2[9], &step2[14]);
    partial_butterfly_avx2(in[10], cospi_22_64, cospi_10_64, &step2[10], &step2[13]);
    partial_butterfly_avx2(in[6], -cospi_26_64, cospi_6_64, &step2[11], &step2[12]);
...
static INLINE void idct32_135_16x32_quarter_3_4_avx2(const __m256i *const in, __m256i *const out) {
    ...
    // stage 1
    partial_butterfly_avx2(in[1], cospi_31_64, cospi_1_64, &step1[16], &step1[31]);
    partial_butterfly_avx2(in[15], -cospi_17_64, cospi_15_64, &step1[17], &step1[30]);
    partial_butterfly_avx2(in[9], cospi_23_64, cospi_9_64, &step1[18], &step1[29]);
    partial_butterfly_avx2(in[7], -cospi_25_64, cospi_7_64, &step1[19], &step1[28]);

    partial_butterfly_avx2(in[5], cospi_27_64, cospi_5_64, &step1[20], &step1[27]);
    partial_butterfly_avx2(in[11], -cospi_21_64, cospi_11_64, &step1[21], &step1[26]);

    partial_butterfly_avx2(in[13], cospi_19_64, cospi_13_64, &step1[22], &step1[25]);
    partial_butterfly_avx2(in[3], -cospi_29_64, cospi_3_64, &step1[23], &step1[24]);
    ...
    step1[16] = step2[16];
    step1[31] = step2[31];
    butterfly_avx2(step2[30], step2[17], cospi_28_64, cospi_4_64, &step1[17], &step1[30]);
    butterfly_avx2(step2[29], step2[18], -cospi_4_64, cospi_28_64, &step1[18], &step1[29]);
    step1[19] = step2[19];
    step1[20] = step2[20];
    butterfly_avx2(step2[26], step2[21], cospi_12_64, cospi_20_64, &step1[21], &step1[26]);
    butterfly_avx2(step2[25], step2[22], -cospi_20_64, cospi_12_64, &step1[22], &step1[25]);
    step1[23] = step2[23];
    step1[24] = step2[24];
    step1[27] = step2[27];
    step1[28] = step2[28];
...
static void idct32_135_16x32_avx2(const __m256i *const in, __m256i *const out) {
    __m256i temp[32];
...
static void idct32_1024_16x32_avx2(const __m256i *const in, __m256i *const out) {
    __m256i temp[32];
