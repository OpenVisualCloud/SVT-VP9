...
static EB_ALIGN(16) const uint8_t filter_type[] = {1, 4, 1, 4, 1, 4, 1, 4, 1, 4, 1, 4, 1, 4, 1, 4,
...
static inline void eb_vp9_luma_weak_filter_avx2_intrin(__m256i top, __m256i curr, __m256i bottom, __m256i curr_prev,
                                                       __m256i curr_next, uint8_t *ptr_denoised, uint8_t *ptr_noise) {
    __m256i top_first_half, bottom_first_half, filter_first_half, filter_second_half, curr_next_first_half,
        curr_next_second_half, weights, curr_left_mid_first_half_weight, curr_left_mid_first_halflo,
        curr_left_mid_first_halfhi, curr_prev_permutation, curr_permutation, curr_next_permutation, top_permutation,
        bottom_permutation;
...
static inline void eb_vp9_chroma_weak_luma_strong_filter_avx2_intrin(__m256i top, __m256i curr, __m256i bottom,
    ...
    __m256i filter_first_half, filter_second_half, curr_next_first_half, curr_next_second_half, weights,
        curr_left_mid_first_half_weight, curr_left_mid_first_halflo, curr_left_mid_first_halfhi, curr_prev_permutation,
        curr_permutation, curr_next_permutation, top_permutation, bottom_permutation, top_prev_permutation,
        top_left_mid_first_halflo, top_left_mid_first_half_weight, top_next_first_half, top_next_permutation,
        top_left_mid_first_halfhi, top_next_second_half, bottom_prev_permutation, bottom_left_mid_first_halflo,
        bottom_left_mid_first_half_weight, bottom_next_permutation, bottom_next_first_half,
    ...
    filter_first_half  = _mm256_adds_epi16(_mm256_adds_epi16(bottom_left_mid_first_halflo, top_left_mid_first_halflo),
                                          curr_left_mid_first_halflo);
    filter_first_half  = _mm256_srli_epi16(filter_first_half, 4);
    filter_second_half = _mm256_adds_epi16(_mm256_adds_epi16(bottom_left_mid_first_halfhi, top_left_mid_first_halfhi),
                                           curr_left_mid_first_halfhi);
...
static inline void eb_vp9_chroma_strong_avx2_intrin(__m256i top, __m256i curr, __m256i bottom, __m256i curr_prev,
                                                    __m256i curr_next, __m256i top_prev, __m256i top_next,
                                                    __m256i bottom_prev, __m256i bottom_next, uint8_t *ptr_denoised) {
    __m256i curr_left_mid_first_halflo, curr_left_mid_first_halfhi, curr_prev_permutation, curr_permutation,
        curr_next_permutation, top_permutation, top_prev_permutation, top_left_mid_first_halflo, top_next_permutation,
        top_left_mid_first_halfhi, bottom_permutation, bottom_prev_permutation, bottom_left_mid_first_halflo,
    ...
    curr_left_mid_first_halflo = _mm256_add_epi16(_mm256_unpacklo_epi8(curr_next_permutation, _mm256_setzero_si256()),
                                                  curr_left_mid_first_halflo);
    ...
    curr_left_mid_first_halfhi = _mm256_add_epi16(_mm256_unpackhi_epi8(curr_next_permutation, _mm256_setzero_si256()),
                                                  curr_left_mid_first_halfhi);
    ...
    top_left_mid_first_halflo = _mm256_add_epi16(_mm256_unpacklo_epi8(top_next_permutation, _mm256_setzero_si256()),
    ...
    top_left_mid_first_halfhi = _mm256_add_epi16(_mm256_unpackhi_epi8(top_next_permutation, _mm256_setzero_si256()),
    ...
    bottom_left_mid_first_halflo = _mm256_add_epi16(
        _mm256_unpacklo_epi8(bottom_permutation, _mm256_setzero_si256()),
        _mm256_unpacklo_epi8(bottom_prev_permutation, _mm256_setzero_si256()));
    bottom_left_mid_first_halflo = _mm256_add_epi16(
        _mm256_unpacklo_epi8(bottom_next_permutation, _mm256_setzero_si256()), bottom_left_mid_first_halflo);

    bottom_left_mid_first_halfhi = _mm256_add_epi16(
        _mm256_unpackhi_epi8(bottom_permutation, _mm256_setzero_si256()),
        _mm256_unpackhi_epi8(bottom_prev_permutation, _mm256_setzero_si256()));
    bottom_left_mid_first_halfhi = _mm256_add_epi16(
        _mm256_unpackhi_epi8(bottom_next_permutation, _mm256_setzero_si256()), bottom_left_mid_first_halfhi);

    curr_left_mid_first_halflo = _mm256_add_epi16(
        _mm256_add_epi16(curr_left_mid_first_halflo, top_left_mid_first_halflo), bottom_left_mid_first_halflo);
    curr_left_mid_first_halfhi = _mm256_add_epi16(
        _mm256_add_epi16(curr_left_mid_first_halfhi, top_left_mid_first_halfhi), bottom_left_mid_first_halfhi);
...
*******************************************/
void eb_vp9_noise_extract_luma_weak_avx2_intrin(EbPictureBufferDesc *input_picture_ptr,
    ...
    __m256i top, curr, bottom, curr_prev, curr_next, second_top, second_curr, second_bottom, second_curr_prev,
        second_curr_next;
    (void)sb_origin_x;
    ...
    //Luma
    {
        ...
        for (kk = 0; kk + MAX_SB_SIZE <= pic_width; kk += MAX_SB_SIZE) {
            for (jj = 0; jj < sb_height; jj++) {
                ...
                eb_vp9_luma_weak_filter_avx2_intrin(second_top,
                                                    second_curr,
                                                    second_bottom,
                                                    second_curr_prev,
                                                    second_curr_next,
...
void eb_vp9_noise_extract_luma_weak_sb_avx2_intrin(EbPictureBufferDesc *input_picture_ptr,
                                                   EbPictureBufferDesc *denoised_picture_ptr,
                                                   EbPictureBufferDesc *noise_picture_ptr, uint32_t sb_origin_y,
                                                   uint32_t sb_origin_x) {
    uint32_t ii, jj;
...
*  strong filter Luma.
*******************************************/
void eb_vp9_noise_extract_luma_strong_avx2_intrin(EbPictureBufferDesc *input_picture_ptr,
    ...
    uint32_t stride_out;
    __m256i  top, curr, bottom, curr_prev, curr_next, top_prev, top_next, bottom_prev, bottom_next, second_top,
        second_curr, second_curr_prev, second_curr_next, second_bottom, second_top_prev, second_top_next,
        second_bottom_prev, second_bottom_next;
    (void)sb_origin_x;
    //Luma
    {
        pic_height = input_picture_ptr->height;
        ...
        top = curr = second_top = second_curr = top_next = top_prev = curr_next = curr_prev = second_curr_prev =
            second_curr_next = second_top_prev = second_top_next = _mm256_setzero_si256();
        for (kk = 0; kk + MAX_SB_SIZE <= pic_width; kk += MAX_SB_SIZE) {
            for (jj = 0; jj < sb_height; jj++) {
                if (sb_origin_y == 0) {
                    if (jj == 0) {
                ...
                eb_vp9_chroma_weak_luma_strong_filter_avx2_intrin(top,
                                                                  curr,
                                                                  bottom,
                                                                  curr_prev,
                                                                  curr_next,
                ...
                eb_vp9_chroma_weak_luma_strong_filter_avx2_intrin(second_top,
                                                                  second_curr,
                                                                  second_bottom,
                                                                  second_curr_prev,
                                                                  second_curr_next,
...
*******************************************/
void eb_vp9_noise_extract_chroma_strong_avx2_intrin(EbPictureBufferDesc *input_picture_ptr,
                                                    EbPictureBufferDesc *denoised_picture_ptr, uint32_t sb_origin_y,
                                                    uint32_t sb_origin_x) {
    uint32_t ii, jj, kk;
    uint32_t pic_height, sb_height;
    ...
    __m256i  top, curr, bottom, curr_prev, curr_next, top_prev, top_next, bottom_prev, bottom_next, top_cr, curr_cr,
        bottom_cr, curr_prev_cr, curr_next_cr, top_prev_cr, top_next_cr, bottom_prev_cr, bottom_next_cr;
    (void)sb_origin_x;
    {
        ...
        top = curr = top_next = top_prev = curr_next = curr_prev = top_cr = curr_cr = top_next_cr = top_prev_cr =
            curr_next_cr = curr_prev_cr = _mm256_setzero_si256();
        ...
        for (kk = 0; kk + MAX_SB_SIZE / 2 <= pic_width; kk += MAX_SB_SIZE / 2) {
            for (jj = 0; jj < sb_height; jj++) {
                if (sb_origin_y == 0) {
                    ...
                    if (jj == 0) {
                        ...
                        curr_prev_cr = _mm256_loadu_si256(
                            (__m256i *)(ptr_in_cr - 1 + kk + ((1 + jj) * stride_in_cr - stride_in_cr)));
                ...
                eb_vp9_chroma_strong_avx2_intrin(top,
                                                 curr,
                                                 bottom,
                                                 curr_prev,
                                                 curr_next,
                ...
                eb_vp9_chroma_strong_avx2_intrin(top_cr,
                                                 curr_cr,
                                                 bottom_cr,
                                                 curr_prev_cr,
                                                 curr_next_cr,
...
*  weak filter chroma.
*******************************************/
void eb_vp9_noise_extract_chroma_weak_avx2_intrin(EbPictureBufferDesc *input_picture_ptr,
                                                  EbPictureBufferDesc *denoised_picture_ptr, uint32_t sb_origin_y,
                                                  uint32_t sb_origin_x) {
    uint32_t ii, jj, kk;
    uint32_t pic_height, sb_height;
...

    {
        ...
        for (kk = 0; kk + MAX_SB_SIZE / 2 <= pic_width; kk += MAX_SB_SIZE / 2) {
            for (jj = 0; jj < sb_height; jj++) {
                ...
                eb_vp9_chroma_weak_luma_strong_filter_avx2_intrin(top_cr,
                                                                  curr_cr,
                                                                  bottom_cr,
                                                                  curr_prev_cr,
                                                                  curr_next_cr,
