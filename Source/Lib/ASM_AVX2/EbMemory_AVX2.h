...
#define pair_set_epi16_avx2(a, b) _mm256_set1_epi32((int)((uint16_t)(a) | ((uint32_t)(b) << 16)))

static INLINE __m256i load8bit_4x4_avx2(const uint8_t *const src, const uint32_t stride) {
    __m128i src01, src23;
...
static INLINE __m256i load8bit_8x4_avx2(const uint8_t *const src, const uint32_t stride) {
    __m128i src01, src23;
...
static INLINE __m256i load8bit_16x2_avx2(const uint8_t *const src, const uint32_t stride) {
...
static INLINE __m256i load8bit_16x2_unaligned_avx2(const uint8_t *const src, const uint32_t stride) {
    const __m128i src0 = _mm_loadu_si128((__m128i *)(src + 0 * stride));
    const __m128i src1 = _mm_loadu_si128((__m128i *)(src + 1 * stride));
    return _mm256_setr_m128i(src0, src1);
}

static INLINE __m256i load16bit_signed_8x2_avx2(const int16_t *const src, const uint32_t stride) {
    const __m128i src0 = _mm_load_si128((__m128i *)(src + 0 * stride));
    const __m128i src1 = _mm_load_si128((__m128i *)(src + 1 * stride));
    return _mm256_setr_m128i(src0, src1);
}

static INLINE __m256i load16bit_signed_8x2_rev_avx2(const int16_t *const src, const uint32_t stride) {
    const __m128i src0 = _mm_load_si128((__m128i *)(src + 0 * stride));
    const __m128i src1 = _mm_load_si128((__m128i *)(src + 1 * stride));
    return _mm256_set_m128i(src0, src1);
}

static INLINE void store16bit_signed_8x2_avx2(const __m256i output, const int16_t *const dst, const uint32_t stride) {
