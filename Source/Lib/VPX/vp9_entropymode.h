...
typedef struct frame_contexts {
    ...
    vpx_prob              switchable_interp_prob[SWITCHABLE_FILTER_CONTEXTS][SWITCHABLE_FILTERS - 1];
...
typedef struct FRAME_COUNTS {
    ...
    unsigned int          switchable_interp[SWITCHABLE_FILTER_CONTEXTS][SWITCHABLE_FILTERS];
...
extern const vpx_prob       eb_vp9_kf_uv_mode_prob[INTRA_MODES][INTRA_MODES - 1];
extern const vpx_prob       eb_vp9_kf_y_mode_prob[INTRA_MODES][INTRA_MODES][INTRA_MODES - 1];
extern const vpx_prob       eb_vp9_kf_partition_probs[PARTITION_CONTEXTS][PARTITION_TYPES - 1];
