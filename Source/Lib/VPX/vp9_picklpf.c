...
#endif
    VP9_COMP *cpi, LPF_PICK_METHOD method) {
...
// searched level, filt_guess = q * 0.316206 + 3.87252
        ...
        int filt_guess;
        switch (cm->bit_depth) {
        case VPX_BITS_8: filt_guess = ROUND_POWER_OF_TWO(q * 20723 + 1015158, 18); break;
        case VPX_BITS_10: filt_guess = ROUND_POWER_OF_TWO(q * 20723 + 4060632, 20); break;
        default:
