...
void vpx_filter_block1d8_v2_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d16_v2_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d4_v2_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d16_h2_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d8_h2_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d4_h2_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d16_v2_avg_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d16_h2_avg_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d8_v2_avg_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d8_h2_avg_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d4_v2_avg_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
void vpx_filter_block1d4_h2_avg_ssse3(const uint8_t *src_ptr, ptrdiff_t src_pitch, uint8_t *output_ptr, ptrdiff_t out_pitch, uint32_t output_height, const int16_t *filter);
...
void vpx_d117_predictor_16x16_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void(*vpx_d117_predictor_16x16)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void vpx_d117_predictor_32x32_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void vpx_d117_predictor_32x32_avx2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void(*vpx_d117_predictor_32x32)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void vpx_d117_predictor_4x4_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void vpx_d117_predictor_4x4_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void(*vpx_d117_predictor_4x4)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void vpx_d117_predictor_8x8_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void vpx_d117_predictor_8x8_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
RTCD_EXTERN void(*vpx_d117_predictor_8x8)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);

void vpx_d135_predictor_16x16_c(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
void vpx_d135_predictor_16x16_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
void vpx_d135_predictor_32x32_avx2(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
void vpx_d135_predictor_4x4_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
void vpx_d135_predictor_8x8_ssse3(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
RTCD_EXTERN void(*vpx_d45e_predictor_4x4)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
RTCD_EXTERN void(*vpx_d63e_predictor_4x4)(uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left);
...
void vpx_idct32x32_34_add_avx2(const tran_low_t *input, uint8_t *dest, int stride);
...
static void setup_rtcd_internal(uint32_t asm_type)
{
    ...
    if (flags & HAS_SSSE3) vpx_d117_predictor_4x4 = vpx_d117_predictor_4x4_ssse3;
    vpx_d117_predictor_8x8 = vpx_d117_predictor_8x8_c;
    if (flags & HAS_SSSE3) vpx_d117_predictor_8x8 = vpx_d117_predictor_8x8_ssse3;
    vpx_d117_predictor_16x16 = vpx_d117_predictor_16x16_c;
    if (flags & HAS_SSSE3) vpx_d117_predictor_16x16 = vpx_d117_predictor_16x16_ssse3;
    vpx_d117_predictor_32x32 = vpx_d117_predictor_32x32_c;
    if (flags & HAS_AVX2) vpx_d117_predictor_32x32 = vpx_d117_predictor_32x32_avx2;
    vpx_d135_predictor_4x4 = vpx_d135_predictor_4x4_c;
    if (flags & HAS_SSSE3) vpx_d135_predictor_4x4 = vpx_d135_predictor_4x4_ssse3;
    vpx_d135_predictor_8x8 = vpx_d135_predictor_8x8_c;
    if (flags & HAS_SSSE3) vpx_d135_predictor_8x8 = vpx_d135_predictor_8x8_ssse3;
    vpx_d135_predictor_16x16 = vpx_d135_predictor_16x16_c;
    if (flags & HAS_SSSE3) vpx_d135_predictor_16x16 = vpx_d135_predictor_16x16_ssse3;
    vpx_d135_predictor_32x32 = vpx_d135_predictor_32x32_c;
    if (flags & HAS_AVX2) vpx_d135_predictor_32x32 = vpx_d135_predictor_32x32_avx2;
    ...
    vpx_d45e_predictor_4x4 = vpx_d45e_predictor_4x4_c;
    ...
    vpx_d63e_predictor_4x4 = vpx_d63e_predictor_4x4_c;
    ...
    vpx_he_predictor_4x4 = vpx_he_predictor_4x4_c;
#endif
    ...
    if (flags & HAS_AVX2) vpx_idct32x32_34_add = vpx_idct32x32_34_add_avx2;
    ...
    vpx_iwht4x4_1_add = vpx_iwht4x4_1_add_c;
    ...
    vpx_scaled_avg_2d = vpx_scaled_avg_2d_c;
    vpx_scaled_avg_horiz = vpx_scaled_avg_horiz_c;
    vpx_scaled_avg_vert = vpx_scaled_avg_vert_c;
    vpx_scaled_horiz = vpx_scaled_horiz_c;
    ...
    vpx_ve_predictor_4x4 = vpx_ve_predictor_4x4_c;
