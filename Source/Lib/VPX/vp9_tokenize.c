...
const TOKENVALUE *eb_vp9_dct_cat_lt_10_value_tokens =
...
const int *eb_vp9_dct_cat_lt_10_value_cost =
...
static void set_entropy_context_b(MACROBLOCKD *const xd, int plane, int block, int row, int col,
...
static void tokenize_b(MACROBLOCKD *xd, int plane, int block, int row, int col,
