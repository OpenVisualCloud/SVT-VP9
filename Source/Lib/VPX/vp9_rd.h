...
#define RDCOST(RM, DM, R, D) (ROUND_POWER_OF_TWO(((int64_t)R) * (RM), VP9_PROB_COST_SHIFT) + ((int64_t)D << DM))
...
int vp9_raster_block_offset(BLOCK_SIZE plane_bsize, int raster_block, int stride);
