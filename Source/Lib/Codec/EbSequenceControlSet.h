 ...
 **************************************/
extern EbErrorType eb_vp9_sequence_control_set_ctor(EbPtr *object_dbl_ptr, EbPtr object_init_data_ptr);

extern EbErrorType eb_vp9_copy_sequence_control_set(SequenceControlSet *dst, SequenceControlSet *src);
