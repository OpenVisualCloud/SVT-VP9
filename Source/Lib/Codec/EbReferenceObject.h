 ...
 **************************************/
extern EbErrorType eb_vp9_reference_object_ctor(EbPtr *object_dbl_ptr, EbPtr object_init_data_ptr);

extern EbErrorType eb_vp9_pa_reference_object_ctor(EbPtr *object_dbl_ptr, EbPtr object_init_data_ptr);
