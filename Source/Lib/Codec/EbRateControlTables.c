 ...
 **************************************/
EbErrorType rate_control_tables_ctor(RateControlTables *initial_rate_control_tables_array) {
        ...
        for (interval_index = 0; interval_index < NUMBER_OF_SAD_INTERVALS; interval_index++) {
            for (temporal_index = 0; temporal_index < MAX_TEMPORAL_LAYERS; temporal_index++) {
                if (interval_index < (NUMBER_OF_SAD_INTERVALS >> 1)) {
                    ...
                    initial_rate_control_tables_array[qp_index].sad_bits_array[temporal_index][interval_index] = CLIP3(
                        1,
                        (uint16_t)((1 << 15) - 1),
                        (uint16_t)initial_rate_control_sad64x64_tables[qp_index * (NUMBER_OF_SAD_INTERVALS >> 1) +
                                                                       interval_index]);

                    initial_rate_control_tables_array[qp_index]
                        .intra_sad_bits_array[temporal_index][interval_index] = CLIP3(
                        1,
                        (uint16_t)((1 << 15) - 1),
                        (uint16_t)initial_rate_control_intra_sad64x64_tables[qp_index * (NUMBER_OF_SAD_INTERVALS >> 1) +
                                                                             interval_index]);
                    ...
                    initial_rate_control_tables_array[qp_index].intra_sad_bits_array[temporal_index][interval_index] =
                        CLIP3(1,
                              (uint16_t)((1 << 15) - 1),
                              initial_rate_control_intra_sad64x64_tables[qp_index * (NUMBER_OF_SAD_INTERVALS >> 1) +
                                                                         ((NUMBER_OF_SAD_INTERVALS >> 1) - 1)]);
                }
            }
        }
