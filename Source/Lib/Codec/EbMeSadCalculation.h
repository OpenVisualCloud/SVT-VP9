...
* Function Types
***************************************/
typedef void (*EbSadCalculation8x8and16x16Type)(uint8_t *src, uint32_t src_stride, uint8_t *ref, uint32_t ref_stride,
                                                uint32_t *p_best_sad8x8, uint32_t *p_best_sad16x16,
                                                uint32_t *p_best_mv8x8, uint32_t *p_best_mv16x16, uint32_t mv,
                                                uint32_t *p_sad16x16);

typedef void (*EbSadCalculation32x32and64x64Type)(uint32_t *p_sad16x16, uint32_t *p_best_sad32x32,
                                                  uint32_t *p_best_sad64x64, uint32_t *p_best_mv32x32,
                                                  uint32_t *p_best_mv64x64, uint32_t mv);

typedef void (*EbInializeBuffer32Bits)(uint32_t *pointer, uint32_t count128, uint32_t count32, uint32_t value);
