...
void copy_api_from_app(
	...
	sequence_control_set_ptr->static_config.vbvMaxrate = ((EbSvtVp9EncConfiguration*)p_component_parameter_structure)->vbvMaxrate;
	sequence_control_set_ptr->static_config.vbvBufsize = ((EbSvtVp9EncConfiguration*)p_component_parameter_structure)->vbvBufsize;
