...
extern void eb_vp9_picture_addition(uint8_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
                                    uint32_t residual_stride, uint8_t *recon_ptr, uint32_t recon_stride, uint32_t width,
                                    uint32_t height);

extern EbErrorType picture_copy8_bit(EbPictureBufferDesc *src, uint32_t src_luma_origin_index,
                                     ...
                                     uint32_t chroma_area_height, uint32_t component_mask);

extern EbErrorType picture_full_distortion(EbPictureBufferDesc *coeff, uint32_t coeff_origin_index,
...
//Residual Data
extern void picture_residual(uint8_t *input, uint32_t input_stride, uint8_t *pred, uint32_t pred_stride,
                             int16_t *residual, uint32_t residual_stride, uint32_t area_width, uint32_t area_height);

extern void picture_sub_sampled_residual(uint8_t *input, uint32_t input_stride, uint8_t *pred, uint32_t pred_stride,
                                         int16_t *residual, uint32_t residual_stride, uint32_t area_width,
                                         uint32_t area_height, uint8_t last_line);

extern void picture_residual16bit(uint16_t *input, uint32_t input_stride, uint16_t *pred, uint32_t pred_stride,
                                  int16_t *residual, uint32_t residual_stride, uint32_t area_width,
...
* Function Types
***************************************/
typedef void (*EbAddKernelType)(uint8_t *pred_ptr, uint32_t pred_stride, int16_t *residual_ptr,
                                uint32_t residual_stride, uint8_t *recon_ptr, uint32_t recon_stride, uint32_t width,
                                uint32_t height);
...
typedef void (*EbResdKernelType16Bit)(uint16_t *input, uint32_t input_stride, uint16_t *pred, uint32_t pred_stride,
                                      int16_t *residual, uint32_t residual_stride, uint32_t area_width,
                                      uint32_t area_height);
...
typedef void (*EbResdKernelSubsampledType)(uint8_t *input, uint32_t input_stride, uint8_t *pred, uint32_t pred_stride,
                                           int16_t *residual, uint32_t residual_stride, uint32_t area_width,
                                           uint32_t area_height, uint8_t last_line);
