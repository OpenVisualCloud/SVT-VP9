...
EB_ALIGN(16)
static const uint8_t ndp_refinement_control_nref[MAX_TEMPORAL_LAYERS /*temporal layer*/][4 /*cu Size*/] = {
    //   64                         32                              16                  8
...
EB_ALIGN(16)
static const uint8_t ndp_refinement_control_fast[MAX_TEMPORAL_LAYERS /*temporal layer*/][4 /*cu Size*/] = {
    //   64                         32                              16                  8
    /* layer-0 */ {Pred + Predp1 + Predp2, Pred + Predp1, Pred + Predp1, Pred + Predm1},
...
EB_ALIGN(16)
static const uint8_t ndp_refinement_control_islice[4 /*cu Size*/] = {
    Predp1, Pred + Predp1 + Predp2, Predm1 + Pred + Predp1, Predm1 + Pred};

// Max FullCandidates Settings For Intra Frame
EB_ALIGN(16)
static const uint8_t ndp_refinement_control_islice_sub4_k[4 /*cu Size*/] = {
 ...
 **************************************/
extern EbErrorType eb_vp9_mode_decision_configuration_context_ctor(ModeDecisionConfigurationContext **context_dbl_ptr,
                                                                   EbFifo  *rate_control_input_fifo_ptr,
                                                                   EbFifo  *mode_decision_configuration_output_fifo_ptr,
