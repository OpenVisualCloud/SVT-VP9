...
void *set_me_hme_params_sq(MeContext *me_context_ptr, PictureParentControlSet *picture_control_set_ptr,
    ...
    uint8_t resolution_index = input_resolution <= INPUT_SIZE_576p_RANGE_OR_LOWER ? 0 : // 480P
        (input_resolution <= INPUT_SIZE_1080i_RANGE && input_ratio < 2) ? 1
                                                                        : // 720P
        (input_resolution <= INPUT_SIZE_1080i_RANGE && input_ratio > 3) ? 2
                                                                        : // 1080I
        (input_resolution <= INPUT_SIZE_1080p_RANGE) ? 3
                                                     : // 1080I
        4; // 4K
    ...
    me_context_ptr->hme_level0_total_search_area_width =
        hme_level0_total_search_area_width_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_total_search_area_height =
        hme_level0_total_search_area_height_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_width_array[0] =
        hme_level0_search_area_in_width_array_right_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_width_array[1] =
        hme_level0_search_area_in_width_array_left_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_height_array[0] =
        hme_level0_search_area_in_height_array_top_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_height_array[1] =
        hme_level0_search_area_in_height_array_bottom_sq[resolution_index][hme_me_level];
    // HME Level1
    me_context_ptr->hme_level1_search_area_in_width_array[0] =
        hme_level1_search_area_in_width_array_right_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_width_array[1] =
        hme_level1_search_area_in_width_array_left_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_height_array[0] =
        hme_level1_search_area_in_height_array_top_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_height_array[1] =
        hme_level1_search_area_in_height_array_bottom_sq[resolution_index][hme_me_level];
    // HME Level2
    me_context_ptr->hme_level2_search_area_in_width_array[0] =
        hme_level2_search_area_in_width_array_right_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_width_array[1] =
        hme_level2_search_area_in_width_array_left_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_height_array[0] =
        hme_level2_search_area_in_height_array_top_sq[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_height_array[1] =
        hme_level2_search_area_in_height_array_bottom_sq[resolution_index][hme_me_level];
    ...
    if (input_resolution == INPUT_SIZE_4K_RANGE) {
        if ((sequence_control_set_ptr->static_config.frame_rate >> 16) <= 30) {
            if (hme_me_level == ENC_MODE_5 || hme_me_level == ENC_MODE_6) {
                me_context_ptr->hme_level0_total_search_area_width = MAX(
                    128, me_context_ptr->hme_level0_total_search_area_width);
                me_context_ptr->hme_level0_total_search_area_height = MAX(
                    64, me_context_ptr->hme_level0_total_search_area_height);
                me_context_ptr->hme_level0_search_area_in_width_array[0] = MAX(
                    64, me_context_ptr->hme_level0_search_area_in_width_array[0]);
                me_context_ptr->hme_level0_search_area_in_width_array[1] = MAX(
                    64, me_context_ptr->hme_level0_search_area_in_width_array[1]);
                me_context_ptr->hme_level0_search_area_in_height_array[0] = MAX(
                    32, me_context_ptr->hme_level0_search_area_in_height_array[0]);
                me_context_ptr->hme_level0_search_area_in_height_array[1] = MAX(
                    32, me_context_ptr->hme_level0_search_area_in_height_array[1]);
            } else if (hme_me_level == ENC_MODE_7 || hme_me_level == ENC_MODE_8) {
                me_context_ptr->hme_level0_total_search_area_width = MAX(
                    96, me_context_ptr->hme_level0_total_search_area_width);
                me_context_ptr->hme_level0_total_search_area_height = MAX(
                    64, me_context_ptr->hme_level0_total_search_area_height);
                me_context_ptr->hme_level0_search_area_in_width_array[0] = MAX(
                    48, me_context_ptr->hme_level0_search_area_in_width_array[0]);
                me_context_ptr->hme_level0_search_area_in_width_array[1] = MAX(
                    48, me_context_ptr->hme_level0_search_area_in_width_array[1]);
                me_context_ptr->hme_level0_search_area_in_height_array[0] = MAX(
                    32, me_context_ptr->hme_level0_search_area_in_height_array[0]);
                me_context_ptr->hme_level0_search_area_in_height_array[1] = MAX(
                    32, me_context_ptr->hme_level0_search_area_in_height_array[1]);
                ...
                me_context_ptr->hme_level0_total_search_area_width = MAX(
                    64, me_context_ptr->hme_level0_total_search_area_width);
                me_context_ptr->hme_level0_total_search_area_height = MAX(
                    48, me_context_ptr->hme_level0_total_search_area_height);
                me_context_ptr->hme_level0_search_area_in_width_array[0] = MAX(
                    32, me_context_ptr->hme_level0_search_area_in_width_array[0]);
                me_context_ptr->hme_level0_search_area_in_width_array[1] = MAX(
                    32, me_context_ptr->hme_level0_search_area_in_width_array[1]);
                me_context_ptr->hme_level0_search_area_in_height_array[0] = MAX(
                    24, me_context_ptr->hme_level0_search_area_in_height_array[0]);
                me_context_ptr->hme_level0_search_area_in_height_array[1] = MAX(
                    24, me_context_ptr->hme_level0_search_area_in_height_array[1]);
            }
        }
    }
...
void *eb_vp9_set_me_hme_params_oq(MeContext *me_context_ptr, PictureParentControlSet *picture_control_set_ptr,
    ...
    // HME Level0
    me_context_ptr->hme_level0_total_search_area_width =
        hme_level0_total_search_area_width_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_total_search_area_height =
        hme_level0_total_search_area_height_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_width_array[0] =
        hme_level0_search_area_in_width_array_right_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_width_array[1] =
        hme_level0_search_area_in_width_array_left_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_height_array[0] =
        hme_level0_search_area_in_height_array_top_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_height_array[1] =
        hme_level0_search_area_in_height_array_bottom_oq[resolution_index][hme_me_level];
    // HME Level1
    me_context_ptr->hme_level1_search_area_in_width_array[0] =
        hme_level1_search_area_in_width_array_right_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_width_array[1] =
        hme_level1_search_area_in_width_array_left_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_height_array[0] =
        hme_level1_search_area_in_height_array_top_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_height_array[1] =
        hme_level1_search_area_in_height_array_bottom_oq[resolution_index][hme_me_level];
    // HME Level2
    me_context_ptr->hme_level2_search_area_in_width_array[0] =
        hme_level2_search_area_in_width_array_right_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_width_array[1] =
        hme_level2_search_area_in_width_array_left_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_height_array[0] =
        hme_level2_search_area_in_height_array_top_oq[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_height_array[1] =
        hme_level2_search_area_in_height_array_bottom_oq[resolution_index][hme_me_level];
...
void *set_me_hme_params_vmaf(MeContext *me_context_ptr, PictureParentControlSet *picture_control_set_ptr,
    ...
    // HME Level0
    me_context_ptr->hme_level0_total_search_area_width =
        hme_level0_total_search_area_width_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_total_search_area_height =
        hme_level0_total_search_area_height_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_width_array[0] =
        hme_level0_search_area_in_width_array_right_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_width_array[1] =
        hme_level0_search_area_in_width_array_left_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_height_array[0] =
        hme_level0_search_area_in_height_array_top_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level0_search_area_in_height_array[1] =
        hme_level0_search_area_in_height_array_bottom_vmaf[resolution_index][hme_me_level];
    // HME Level1
    me_context_ptr->hme_level1_search_area_in_width_array[0] =
        hme_level1_search_area_in_width_array_right_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_width_array[1] =
        hme_level1_search_area_in_width_array_left_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_height_array[0] =
        hme_level1_search_area_in_height_array_top_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level1_search_area_in_height_array[1] =
        hme_level1_search_area_in_height_array_bottom_vmaf[resolution_index][hme_me_level];
    // HME Level2
    me_context_ptr->hme_level2_search_area_in_width_array[0] =
        hme_level2_search_area_in_width_array_right_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_width_array[1] =
        hme_level2_search_area_in_width_array_left_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_height_array[0] =
        hme_level2_search_area_in_height_array_top_vmaf[resolution_index][hme_me_level];
    me_context_ptr->hme_level2_search_area_in_height_array[1] =
        hme_level2_search_area_in_height_array_bottom_vmaf[resolution_index][hme_me_level];
...
EbErrorType eb_vp9_motion_estimation_context_ctor(MotionEstimationContext **context_dbl_ptr,
...
EbErrorType compute_zz_sad(MotionEstimationContext *context_ptr, SequenceControlSet *sequence_control_set_ptr,
    ...
    PictureParentControlSet *previous_picture_control_set_wrapper_ptr =
        ((PictureParentControlSet *)picture_control_set_ptr->previous_picture_control_set_wrapper_ptr->object_ptr);
    EbPictureBufferDesc *previous_input = previous_picture_control_set_wrapper_ptr->enhanced_picture_ptr;
    ...
    for (ysb_index = y_sb_start_index; ysb_index < y_sb_end_index; ++ysb_index) {
        for (xsb_index = x_sb_start_index; xsb_index < x_sb_end_index; ++xsb_index) {
            ...
            if (sb_params->is_complete_sb) {
                block_index_sub = (sixteenth_decimated_picture_ptr->origin_y + (sb_origin_y >> 2)) *
                        sixteenth_decimated_picture_ptr->stride_y +
                    sixteenth_decimated_picture_ptr->origin_x + (sb_origin_x >> 2);
                block_index = (previous_input->origin_y + sb_origin_y) * previous_input->stride_y +
                    (previous_input->origin_x + sb_origin_x);

                // 1/16 collocated LCU decimation
                eb_vp9_decimation_2d(&previous_input->buffer_y[block_index],
                                     previous_input->stride_y,
                                     MAX_SB_SIZE,
                                     MAX_SB_SIZE,
...
EbErrorType eb_vp9_signal_derivation_me_kernel_sq(SequenceControlSet      *sequence_control_set_ptr,
    ...
    if (sequence_control_set_ptr->static_config.use_default_me_hme) {
        set_me_hme_params_sq(context_ptr->me_context_ptr,
...
EbErrorType eb_vp9_signal_derivation_me_kernel_vmaf(SequenceControlSet      *sequence_control_set_ptr,
    ...
    // Set ME/HME search regions
    if (sequence_control_set_ptr->static_config.use_default_me_hme) {
        set_me_hme_params_vmaf(context_ptr->me_context_ptr,
                               picture_control_set_ptr,
                               sequence_control_set_ptr,
                               sequence_control_set_ptr->input_resolution);
    } else {
...
* eb_vp9_get_mv
  ...
  Output  : List0 MV
******************************************************/
void eb_vp9_get_mv(PictureParentControlSet *picture_control_set_ptr, uint32_t sb_index, int32_t *x_current_mv,
...
******************************************************/
static void get_me_dist(PictureParentControlSet *picture_control_set_ptr, uint32_t sb_index, uint32_t *distortion) {
...
static void stationary_edge_over_update_over_time_sb_part1(SequenceControlSet      *sequence_control_set_ptr,
                                                           PictureParentControlSet *picture_control_set_ptr,
                                                           uint32_t                 sb_index) {
    ...
    if (sb_params->potential_logo_sb && sb_params->is_complete_sb) {
        ...
        uint64_t varOfVar   = (((int32_t)(var0 - averageVar) * (int32_t)(var0 - averageVar)) +
                             ...
                             ((int32_t)(var3 - averageVar) * (int32_t)(var3 - averageVar))) >>
            2;
...
static void stationary_edge_over_update_over_time_sb_part2(SequenceControlSet      *sequence_control_set_ptr,
                                                           PictureParentControlSet *picture_control_set_ptr,
                                                           uint32_t                 sb_index) {
...
void *eb_vp9_motion_estimation_kernel(void *input_ptr) {
    ...
    for (;;) {
        ...
        eb_vp9_get_full_object(context_ptr->picture_decision_results_input_fifo_ptr, &input_results_wrapper_ptr);
        ...
        SEGMENT_CONVERT_IDX_TO_XY(
            segment_index, xSegmentIndex, ySegmentIndex, picture_control_set_ptr->me_segments_column_count);
        x_sb_start_index = SEGMENT_START_IDX(
            xSegmentIndex, picture_width_in_sb, picture_control_set_ptr->me_segments_column_count);
        x_sb_end_index = SEGMENT_END_IDX(
            xSegmentIndex, picture_width_in_sb, picture_control_set_ptr->me_segments_column_count);
        y_sb_start_index = SEGMENT_START_IDX(
            ySegmentIndex, picture_height_in_sb, picture_control_set_ptr->me_segments_row_count);
        ...
        if (picture_control_set_ptr->slice_type != I_SLICE) {
            ...
            for (ysb_index = y_sb_start_index; ysb_index < y_sb_end_index; ++ysb_index) {
                for (xsb_index = x_sb_start_index; xsb_index < x_sb_end_index; ++xsb_index) {
                    ...
                    buffer_index = (input_picture_ptr->origin_y + sb_origin_y) * input_picture_ptr->stride_y +
                    ...
                    if (picture_control_set_ptr->enable_hme_level_1_flag) {
                        buffer_index = (quarter_decimated_picture_ptr->origin_y + (sb_origin_y >> 1)) *
                    ...
                    if (picture_control_set_ptr->enable_hme_level_0_flag) {
                        buffer_index = (sixteenth_decimated_picture_ptr->origin_y + (sb_origin_y >> 2)) *
                                sixteenth_decimated_picture_ptr->stride_y +
                            sixteenth_decimated_picture_ptr->origin_x + (sb_origin_x >> 2);
                    ...
                    motion_estimate_sb(picture_control_set_ptr,
                                       sb_index,
                                       sb_origin_x,
                                       sb_origin_y,
                                       context_ptr->me_context_ptr,
        ...
        for (ysb_index = y_sb_start_index; ysb_index < y_sb_end_index; ++ysb_index) {
            for (xsb_index = x_sb_start_index; xsb_index < x_sb_end_index; ++xsb_index) {
                ...
                stationary_edge_over_update_over_time_sb_part1(
                    sequence_control_set_ptr, picture_control_set_ptr, sb_index);

                //Check conditions for stationary edge over time Part 2
                if (!picture_control_set_ptr->end_of_sequence_flag &&
            ...
            if (picture_control_set_ptr->slice_type != I_SLICE) {
                ...
                for (ysb_index = y_sb_start_index; ysb_index < y_sb_end_index; ++ysb_index) {
                    for (xsb_index = x_sb_start_index; xsb_index < x_sb_end_index; ++xsb_index) {
                        ...
                        if (sb_params->is_complete_sb) {
                            sad_interval_index = (uint16_t)(picture_control_set_ptr->rcme_distortion[sb_index] >>
                            ...
                            if (sad_interval_index > (NUMBER_OF_SAD_INTERVALS >> 1) - 1) {
                                uint16_t sadIntervalIndexTemp = sad_interval_index -
                            ...
                            if (intra_sad_interval_index > (NUMBER_OF_SAD_INTERVALS >> 1) - 1) {
                                ...
                                intra_sad_interval_index = ((NUMBER_OF_SAD_INTERVALS >> 1) - 1) +
                                    (sadIntervalIndexTemp >> 3);
                            }
                ...
                for (ysb_index = y_sb_start_index; ysb_index < y_sb_end_index; ++ysb_index) {
                    for (xsb_index = x_sb_start_index; xsb_index < x_sb_end_index; ++xsb_index) {
                        ...
                        sb_width  = (sequence_control_set_ptr->luma_width - sb_origin_x) < MAX_SB_SIZE
                             ? sequence_control_set_ptr->luma_width - sb_origin_x
                             : MAX_SB_SIZE;
                        sb_height = (sequence_control_set_ptr->luma_height - sb_origin_y) < MAX_SB_SIZE
                            ? sequence_control_set_ptr->luma_height - sb_origin_y
                            : MAX_SB_SIZE;
        ...
        eb_vp9_get_empty_object(context_ptr->motion_estimation_results_output_fifo_ptr, &output_results_wrapper_ptr);
