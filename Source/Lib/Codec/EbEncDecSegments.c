    ...
    uint32_t        pic_height_sb)
{
    ...
    for(row_index=0; row_index < segments_ptr->segment_row_count; ++row_index) {
        y = ((row_index * segments_ptr->sb_row_count) + (segments_ptr->segment_row_count-1)) / segments_ptr->segment_row_count;
        yLast = ((((row_index+1) * segments_ptr->sb_row_count) + (segments_ptr->segment_row_count-1)) / segments_ptr->segment_row_count) - 1;
