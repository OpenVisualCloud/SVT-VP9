...
extern "C" {
#endif
extern EbErrorType eb_video_usability_info_ctor(AppVideoUsabilityInfo *vui_ptr);

extern void eb_video_usability_info_copy(AppVideoUsabilityInfo *dst_vui_ptr, AppVideoUsabilityInfo *src_vui_ptr);

extern void eb_picture_timeing_sei_ctor(AppPictureTimingSei *pic_timing_ptr);

extern void eb_buffering_period_sei_ctor(AppBufferingPeriodSei *buffering_period_ptr);
