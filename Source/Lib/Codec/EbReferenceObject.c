...
static void initialize_samples_neighboring_reference_picture16_bit(EbByte recon_samples_buffer_ptr, uint16_t stride,
...
static void initialize_samples_neighboring_reference_picture8_bit(EbByte recon_samples_buffer_ptr, uint16_t stride,
                                                                  uint16_t recon_width, uint16_t recon_height,
                                                                  uint16_t left_padding, uint16_t top_padding) {
...
static void initialize_samples_neighboring_reference_picture(
    EbReferenceObject *reference_object, EbPictureBufferDescInitData *picture_buffer_desc_init_data_ptr,
    EbBitDepth bit_depth) {
    if (bit_depth == EB_10BIT) {
        initialize_samples_neighboring_reference_picture16_bit(reference_object->reference_picture16bit->buffer_y,
        ...
        initialize_samples_neighboring_reference_picture16_bit(reference_object->reference_picture16bit->buffer_cb,
        ...
        initialize_samples_neighboring_reference_picture16_bit(reference_object->reference_picture16bit->buffer_cr,
        ...
        initialize_samples_neighboring_reference_picture8_bit(reference_object->reference_picture->buffer_y,
        ...
        initialize_samples_neighboring_reference_picture8_bit(reference_object->reference_picture->buffer_cb,
        ...
        initialize_samples_neighboring_reference_picture8_bit(reference_object->reference_picture->buffer_cr,
 ...
 *  the descriptor.
 *****************************************/
EbErrorType eb_vp9_reference_object_ctor(EbPtr *object_dbl_ptr, EbPtr object_init_data_ptr) {
    ...
    *object_dbl_ptr = (EbPtr)reference_object;
    ...
    if (picture_buffer_desc_init_data16_bit_ptr.bit_depth == EB_10BIT) {
        return_error = eb_vp9_picture_buffer_desc_ctor((EbPtr *)&(reference_object->reference_picture16bit),
                                                       (EbPtr)&picture_buffer_desc_init_data16_bit_ptr);

        initialize_samples_neighboring_reference_picture(reference_object,
                                                         &picture_buffer_desc_init_data16_bit_ptr,
                                                         picture_buffer_desc_init_data16_bit_ptr.bit_depth);

    } else {
        return_error = eb_vp9_picture_buffer_desc_ctor((EbPtr *)&(reference_object->reference_picture),
                                                       (EbPtr)picture_buffer_desc_init_data_ptr);

        initialize_samples_neighboring_reference_picture(
            reference_object, picture_buffer_desc_init_data_ptr, picture_buffer_desc_init_data16_bit_ptr.bit_depth);
    }
 ...
 *  the descriptor.
 *****************************************/
EbErrorType eb_vp9_pa_reference_object_ctor(EbPtr *object_dbl_ptr, EbPtr object_init_data_ptr) {
    ...
    *object_dbl_ptr = (EbPtr)pa_reference_object;
    ...
    return_error = eb_vp9_picture_buffer_desc_ctor((EbPtr *)&(pa_reference_object->input_padded_picture_ptr),
                                                   (EbPtr)picture_buffer_desc_init_data_ptr);
    if (return_error == EB_ErrorInsufficientResources) {
        return EB_ErrorInsufficientResources;
    }
