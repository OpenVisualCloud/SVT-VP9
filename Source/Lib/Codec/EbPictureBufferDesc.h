 ...
 **************************************/
extern EbErrorType eb_vp9_picture_buffer_desc_ctor(EbPtr *object_dbl_ptr, EbPtr object_init_data_ptr);

extern EbErrorType eb_vp9_recon_picture_buffer_desc_ctor(EbPtr *object_dbl_ptr, EbPtr object_init_data_ptr);
