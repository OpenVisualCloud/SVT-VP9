...
/***************************************
    * Function Ptr Types
    ***************************************/
typedef uint32_t (*EbSadkernelNxMType)(uint8_t *src, uint32_t src_stride, uint8_t *ref, uint32_t ref_stride,
                                       uint32_t height, uint32_t width);

static uint32_t nx_m_sad_kernel_void_func(uint8_t *src, uint32_t src_stride, uint8_t *ref, uint32_t ref_stride,
                                          uint32_t height, uint32_t width) {
    (void)src;
    (void)src_stride;
    (void)ref;
...
typedef void (*EbSadloopkernelNxMType)(uint8_t  *src, // input parameter, source samples Ptr
...
typedef void (*EbGeteightsaD8x8)(uint8_t *src, uint32_t src_stride, uint8_t *ref, uint32_t ref_stride,
...
typedef void (*EbGeteightsaD32x32)(uint16_t *p_sad16x16, uint32_t *p_best_sad32x32, uint32_t *p_best_sad64x64,
                                   uint32_t *p_best_mv32x32, uint32_t *p_best_mv64x64, uint32_t mv);

/***************************************
    * Function Tables
    ***************************************/
static EbSadkernelNxMType FUNC_TABLE
    n_x_m_sad_kernel_func_ptr_array[ASM_TYPE_TOTAL][9] = // [eb_vp9_ASM_TYPES][SAD - block height]
    {
        // C_DEFAULT
        {
        ...
        // AVX2
        {
            ...
            /*5      */ nx_m_sad_kernel_void_func,
            /*6 48xM */ compute48x_m_sad_avx2_intrin,
            /*7      */ nx_m_sad_kernel_void_func,
...
static EbGeteightsaD8x8 FUNC_TABLE
    eb_vp9_get_eight_horizontal_search_point_results_8x8_16x16_func_ptr_array[ASM_TYPE_TOTAL] = {
        // C_DEFAULT
...
static EbGeteightsaD32x32 FUNC_TABLE
    eb_vp9_get_eight_horizontal_search_point_results_32x32_64x64_func_ptr_array[ASM_TYPE_TOTAL] = {
        // C_DEFAULT
