...
extern EbErrorType eb_vp9_initial_rate_control_reorder_entry_ctor(InitialRateControlReorderEntry **entry_dbl_ptr,
...
extern EbErrorType eb_vp9_hl_rate_control_histogram_entry_ctor(HlRateControlHistogramEntry **entry_dbl_ptr,
                                                               uint32_t                      picture_number);
